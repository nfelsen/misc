...
client.search({
        ...
        body: {
            ...
            query: {
                ...
                bool: {
                    must_not: { match: { "log2ratio": "log2ratio" }}
                }
            }
        }
    }).then(function (resp) {
            hits = resp.hits.hits
            values = hits.map(function(v) { return v._source})
            // console.log(JSON.stringify(values))

// values.forEach(
d3.tsv("data_heatmap.tsv",
function wtf(d) {
  // console.log(+d.row_idx, "ha2", +d.col_idx, +d.log2ratio )
  // console.log("values")
